(function ($) {
  ...
  $(document).ready(function () {
    ...
    // Mobile Submenu
    $(".primary-menu_list.has-sub.active .primary-menu_link").on("click", function (e) {
      // Check if the clicked link is "About Dr Devu"
      if ($(this).is("#about-link")) {
        // Allow default action for "About Dr Devu"
        return;
      }
      // Prevent default action for other links
      e.preventDefault();
